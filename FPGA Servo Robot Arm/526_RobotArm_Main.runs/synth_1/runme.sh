...
HD_PWD='C:/Xilinx/526_FinalProject/526_RobotArm_Main/526_RobotArm_Main.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_controller.tcl
