...
HD_PWD='C:/Xilinx/526_FinalProject/526_RobotArm_Main/526_RobotArm_Main.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_level_controller.tcl -notrace
